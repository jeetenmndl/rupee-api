...
import RefreshAllTransactions from '@/components/parts/RefreshAllTransactions'

const page = async ({params}) => {


  const result = await fetch(`${process.env.DOMAIN}/api/dashboard/${params.id}/allTransactions`, {
    method: 'GET',
    headers: {
